...
namespace Proyecto_DSWI.Controllers
{
    public class ProductoController : Controller
    {
        ...
        //Conexion
        SqlConnection TIENDAEntities = new SqlConnection(ConfigurationManager.ConnectionStrings["TIENDAEntities"].ConnectionString);
        // GET: Producto
        ...
        List<ProductoO> ListGeneral()
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_LISTAPRODUCTOS", TIENDAEntities);
            TIENDAEntities.Open();
        ...
        List<Producto> ListGeneralA()
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_PRODUCTO", TIENDAEntities);
            TIENDAEntities.Open();
            SqlDataReader dr = cmd.ExecuteReader();
            while (dr.Read())
            {
        ...
        void CRUD(String proceso, List<SqlParameter> pars)
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand(proceso, TIENDAEntities);
        ...
        public JsonResult ObtenerProveedor()
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_LISTAPROVEEDOR", TIENDAEntities);
            TIENDAEntities.Open();
            SqlDataReader dr = cmd.ExecuteReader();
            while (dr.Read())
            {
        ...
        public JsonResult ObtenerCategoria()
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_CATEGORIA", TIENDAEntities);
            TIENDAEntities.Open();
            SqlDataReader dr = cmd.ExecuteReader();
            while (dr.Read())
            {
        ...
        public ActionResult BuscarProducto(int? id= null)
        {
            ...
            List<Producto> aProductos = new List<Producto>();
            SqlCommand cmd = new SqlCommand("SP_BUSCARPRODUCTOID", TIENDAEntities);
            cmd.CommandType = CommandType.StoredProcedure;
